...
/***/ function(module, exports, __webpack_require__) {
	...
	var BookmarksBox = function (_React$Component) {
	  _inherits(BookmarksBox, _React$Component);

	  function BookmarksBox() {
	    _classCallCheck(this, BookmarksBox);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BookmarksBox).call(this));

	    _this.state = { data: [] };
	    return _this;
	  }

	  _createClass(BookmarksBox, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(BookmarkList, { data: this.state.data }),
	...
	var BookmarkList = function BookmarkList(props) {
	  return React.createElement(
	    ...
	    props.data.map(function (item) {
	      return React.createElement(Bookmark, { key: item.id, description: item.description, uri: item.uri });
	    })
	  );
	};
